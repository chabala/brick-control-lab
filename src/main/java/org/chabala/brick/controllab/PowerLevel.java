...
public enum PowerLevel {
    /** Power level 0, turns the output off, and resets the default
     *  power level back to {@link #P8}. */
    P0,
    ...
    /** Power level 7. */
    P7,
    /** Power level 8, highest power level. This is the default when
     *  not specified. */
    P8;
    ...
    /**
     * Enumerates possible power level values for the change power
     * level command.
     */
    PowerLevel() {
    ...
    /**
     * The byte expected by the control lab for the change power
     * level command.
